...
// function createType(propertyValues: { [Key: string]: [boolean, astncore.SerializableValue] }): astncore.SerializableValue {
...
//     }
// }
// function createDictionary<T>(entries: gapi.IReadonlyDictionary<T>, entryMapper: (entry: T) => astncore.SerializableValue): astncore.SerializableValue {
//     return {
//         commentData: createEmptyCommentData(),
//         type: ["object", {
//             openCharacter: "{",
...
// function createReference<T>(reference: gapi.IReference<T>): astncore.SerializableValue {
//     return {
//         commentData: createEmptyCommentData(),
//         type: ["simple value", {
//             quote: "'",
...
//     }
// }
// function createTaggedUnion(option: string, data: astncore.SerializableValue): astncore.SerializableValue {
//     return {
//         commentData: createEmptyCommentData(),
//         type: ["tagged union", {
//             quote: "'",
...
// function createTextProperty(value: string, quoted = true): astncore.SerializableValue {
//     return {
//         commentData: createEmptyCommentData(),
//         type: ["simple value", {
//             quote: quoted ? "\"" : null,
...
// function createSerializableValueFromSchemaNode(schemaNode: md.Node): astncore.SerializableValue {
//     const properties: { [key: string]: astncore.SerializableProperty } = schemaNode.properties.mapSorted((entry, _key) => {
//         return {
//             commentData: createEmptyCommentData(),
//             quote: "\"",
//             value: createType({
//                 type: [schemaPropertyIsDefault(entry), ((): astncore.SerializableValue => {
//                     switch (entry.type[0]) {
//                         case "collection": {
//                             const $ = entry.type[1]

//                             return createTaggedUnion("collection", createType({
//                                 type: [$.type[0] === "list" && schemaNodeIsDefault($.type[1].node), ((): astncore.SerializableValue => {
//                                     switch ($.type[0]) {
//                                         case "dictionary": {
//                                             const $$ = $.type[1]
...
//     schema: md.Schema
// ): astncore.SerializableValue | null {
